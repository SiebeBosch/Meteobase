...
#define MyAppName "MBANONYMIZE"
#define MyAppVersion "1.000"
#define MyAppPublisher "Hydroconsult"
#define MyAppURL "http://www.sobek.tools"
#define SetupLocation "c:\GITHUB\Meteobase\backend\MBAnonymize\InnoSetup\"
#define BinLocation "c:\GITHUB\Meteobase\backend\MBAnonymize\bin\"
...
;#define mapwingis = "MapWinGIS-only-v5.2.4-x64-VS2017.exe"
  ...
  #define MySourceDir BinLocation + "\x86\Release\net7.0-windows\"
...
[Icons]
;; In start menu:
Name: "{commonstartmenu}\{#MyAppPublisher}\{#MyAppName}"; Filename: "{app}\MBANONYMIZE.exe"; WorkingDir: "{app}"; Comment: "Start MBANONYMIZE"
;; On desktop:
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\MBANONYMIZE.exe"; WorkingDir: "{app}"; Comment: "Start MBANONYMIZE"
...
Filename: "{app}\MBANONYMIZE.exe"; Flags: shellexec runasoriginaluser postinstall nowait skipifsilent; Description: "Start MBANONYMIZE?"
