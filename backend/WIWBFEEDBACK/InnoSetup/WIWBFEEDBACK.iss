...
AppId={{1b317554-ac73-4e8c-88b7-5d75ae2ffe50}
AppName={#MyAppName}
...
OutputBaseFilename=WIWBFEEDBACK-v{#MyAppVersion}-{#CPU}
...
VersionInfoDescription=WIWBFEEDBACK [www.meteobase.nl]
...
[Icons]
;; In start menu:
Name: "{commonstartmenu}\{#MyAppPublisher}\{#MyAppName}"; Filename: "{app}\WIWBFEEDBACK.exe"; WorkingDir: "{app}"; Comment: "Start WIWBFEEDBACK"
;; On desktop:
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\WIWBFEEDBACK.exe"; WorkingDir: "{app}"; Comment: "Start WIWBFEEDBACK"
...
Filename: "{app}\WIWBFEEDBACK.exe"; Flags: shellexec runasoriginaluser postinstall nowait skipifsilent; Description: "Start WIWBFEEDBACK?"
