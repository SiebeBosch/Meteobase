...
#define BinLocation "c:\GITHUB\Meteobase\backend\WIWBHERHALINGSTIJD\bin"
...
AppId={{b5fd966d-7cde-4add-8c7a-5d39fb9610cd}
AppName={#MyAppName}
...
OutputBaseFilename=WIWBHERHALINGSTIJD-v{#MyAppVersion}-{#CPU}
...
VersionInfoDescription=WIWBHERHALINGSTIJD [www.meteobase.nl]
...
[Messages]
BeveledLabel=WIWBHERHALINGSTIJD by Hydroconsult

[Icons]
;; In start menu:
Name: "{commonstartmenu}\{#MyAppPublisher}\{#MyAppName}"; Filename: "{app}\WIWBHERHALINGSTIJD.exe"; WorkingDir: "{app}"; Comment: "Start WIWBHERHALINGSTIJD"
;; On desktop:
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\WIWBHERHALINGSTIJD.exe"; WorkingDir: "{app}"; Comment: "Start WIWBHERHALINGSTIJD"
...
Filename: "{app}\WIWBHERHALINGSTIJD.exe"; Flags: shellexec runasoriginaluser postinstall nowait skipifsilent; Description: "Start WIWBHERHALINGSTIJD?"
