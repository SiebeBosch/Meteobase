...
#define MyAppName "NATIVERASTER"
#define MyAppVersion "3.310"
#define MyAppPublisher "Hydroconsult"
#define MyAppURL "http://www.sobek.tools"
#define SetupLocation "c:\GITHUB\Meteobase\backend\WIWBNATIVERASTER\InnoSetup"
#define BinLocation "c:\GITHUB\Meteobase\backend\WIWBNATIVERASTER\bin"
...
AppId={{cbe9c3b3-2a22-4f2e-8ca4-e7d3eadde01a}
AppName={#MyAppName}
...
OutputBaseFilename=NATIVERASTER-v{#MyAppVersion}-{#CPU}
...
VersionInfoDescription=NATIVERASTER [www.meteobase.nl]
...
[Icons]
;; In start menu:
Name: "{commonstartmenu}\{#MyAppPublisher}\{#MyAppName}"; Filename: "{app}\WIWBNATIVERASTER.exe"; WorkingDir: "{app}"; Comment: "Start WIWBNATIVERASTER"
;; On desktop:
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\WIWBNATIVERASTER.exe"; WorkingDir: "{app}"; Comment: "Start WIWBNATIVERASTER"
...
Filename: "{app}\WIWBNATIVERASTER.exe"; Flags: shellexec runasoriginaluser postinstall nowait skipifsilent; Description: "Start WIWBNATIVERASTER?"
