...
#define BinLocation "c:\GITHUB\Meteobase\backend\WIWBRASTER2ASCII\WIWBRASTER2ASCII\bin"
...
AppId={{56d1af5e-1966-44e1-8663-870e58232b83}
AppName={#MyAppName}
...
OutputBaseFilename=RASTER2ASCII-v{#MyAppVersion}-{#CPU}
...
VersionInfoDescription=RASTER2ASCII [www.meteobase.nl]
...
[Messages]
BeveledLabel=RASTER2ASCII by Hydroconsult

[Icons]
;; In start menu:
Name: "{commonstartmenu}\{#MyAppPublisher}\{#MyAppName}"; Filename: "{app}\WIWBRASTER2ASCII.exe"; WorkingDir: "{app}"; Comment: "Start RASTER2ASCII"
;; On desktop:
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\WIWBRASTER2ASCII.exe"; WorkingDir: "{app}"; Comment: "Start RASTER2ASCII"
...
Filename: "{app}\WIWBRASTER2ASCII.exe"; Flags: shellexec runasoriginaluser postinstall nowait skipifsilent; Description: "Start RASTER2ASCII?"
