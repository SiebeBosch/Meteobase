...
Module WIWBRASTER2ASCII

    'Copyright Siebe Bosch Hydroconsult, 2017
    'Lulofsstraat 55, unit 47 Den Haag, The Netherlands
    'this program converts precipitation and/or evaporation data from the WIWB API
    'to Arc/Info ASCII grids (.ASC).
    ...
    Sub Main()
        ...
        Console.WriteLine("WIWBRASTER2ASCII version 1.80.2")
        ...
        Else
            ...
            RasterData.MailAdres = My.Application.CommandLineArgs(16)
