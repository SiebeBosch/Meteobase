...
#define MyAppName "RASTERBYPOLY"
#define MyAppVersion "3.310"
#define MyAppPublisher "Hydroconsult"
#define MyAppURL "http://www.sobek.tools"
#define SetupLocation "c:\GITHUB\Meteobase\backend\WIWBRASTERBYPOLY\InnoSetup"
#define BinLocation "c:\GITHUB\Meteobase\backend\WIWBRASTERBYPOLY\WIWBRASTERBYPOLY\bin"
...
;#define mapwingis = "MapWinGIS-only-v4.9.6.1-Win32.exe"
  ...
  #define MySourceDir BinLocation + "\x64\Release\"
...
AppId={{01e33a6c-426c-4d7c-ac4a-d46751472a5c}
AppName={#MyAppName}
...
OutputBaseFilename=WIWBRASTERBYPOLY-v{#MyAppVersion}-{#CPU}
...
VersionInfoDescription=WIWB Raster by Poly [www.meteobase.nl]
...
[Messages]
BeveledLabel=WIWB Raster by poly by Hydroconsult

[Icons]
;; In start menu:
Name: "{commonstartmenu}\{#MyAppPublisher}\{#MyAppName}"; Filename: "{app}\WIWBRASTERBYPOLY.exe"; WorkingDir: "{app}"; Comment: "Start Raster by poly"
;; On desktop:
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\WIWBRASTERBYPOLY.exe"; WorkingDir: "{app}"; Comment: "Start Raster by poly"
...
Filename: "{app}\WIWBRASTERBYPOLY.exe"; Flags: shellexec runasoriginaluser postinstall nowait skipifsilent; Description: "Start Raster by poly?"
