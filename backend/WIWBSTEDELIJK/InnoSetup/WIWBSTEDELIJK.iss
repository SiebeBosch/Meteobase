...
#define BinLocation "c:\GITHUB\Meteobase\backend\WIWBSTEDELIJK\bin"
...
OutputBaseFilename=WIWBSTEDELIJK-v{#MyAppVersion}-{#CPU}
...
[Icons]
;; In start menu:
Name: "{commonstartmenu}\{#MyAppPublisher}\{#MyAppName}"; Filename: "{app}\WIWBSTEDELIJK.exe"; WorkingDir: "{app}"; Comment: "Start WIWBSTEDELIJK"
;; On desktop:
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\WIWBSTEDELIJK.exe"; WorkingDir: "{app}"; Comment: "Start WIWBSTEDELIJK"
...
Filename: "{app}\WIWBSTEDELIJK.exe"; Flags: shellexec runasoriginaluser postinstall nowait skipifsilent; Description: "Start WIWBSTEDELIJK?"
