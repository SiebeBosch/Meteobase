...
#define MyAppName "WIWBSTOCHASTEN"
#define MyAppVersion "1.65"
#define MyAppPublisher "Hydroconsult"
#define MyAppURL "http://www.sobek.tools"
#define SetupLocation "c:\DotnetSVN\meteobase\WIWBSTOCHASTEN\InnoSetup"
#define BinLocation "c:\DotnetSVN\meteobase\WIWBSTOCHASTEN\bin"
...
AppId={{e101626a-2638-42a9-9df2-6867b182d309}
AppName={#MyAppName}
...
OutputBaseFilename=WIWBSTOCHASTEN-v{#MyAppVersion}-{#CPU}
...
VersionInfoCopyright=Copyright 2020, Hydroconsult
VersionInfoDescription=WIWBSTOCHASTEN [www.meteobase.nl]
...
[Messages]
BeveledLabel=WIWB Stochasten by Hydroconsult

[Icons]
;; In start menu:
Name: "{commonstartmenu}\{#MyAppPublisher}\{#MyAppName}"; Filename: "{app}\WIWBSTOCHASTEN.exe"; WorkingDir: "{app}"; Comment: "Start WIWBSTOCHASTEN"
;; On desktop:
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\WIWBSTOCHASTEN.exe"; WorkingDir: "{app}"; Comment: "Start WIWBSTOCHASTEN"
...
Filename: "{app}\WIWBSTOCHASTEN.exe"; Flags: shellexec runasoriginaluser postinstall nowait skipifsilent; Description: "Start WIWBSTOCHASTEN?"
