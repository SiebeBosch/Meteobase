...
#define MyAppName "WIWBTOETSING"
#define MyAppVersion "3.300"
#define MyAppPublisher "Hydroconsult"
#define MyAppURL "http://www.sobek.tools"
#define SetupLocation "c:\GITHUB\Meteobase\backend\WIWBTOETSING\InnoSetup"
#define BinLocation "c:\GITHUB\Meteobase\backend\WIWBTOETSING\bin"
...
AppId={{09143e3a-bf4c-4ff5-845a-34370bfe7c47}
AppName={#MyAppName}
...
OutputBaseFilename=WIWBTOETSING-v{#MyAppVersion}-{#CPU}
...
VersionInfoDescription=WIWB Toetsingsdata [www.meteobase.nl]
...
[Messages]
BeveledLabel=WIWB Toetsingsdata by Hydroconsult

[Icons]
;; In start menu:
Name: "{commonstartmenu}\{#MyAppPublisher}\{#MyAppName}"; Filename: "{app}\WIWBTOETSING.exe"; WorkingDir: "{app}"; Comment: "Start WIWBTOETSING"
;; On desktop:
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\WIWBTOETSING.exe"; WorkingDir: "{app}"; Comment: "Start WIWBTOETSING"
...
Filename: "{app}\WIWBTOETSING.exe"; Flags: shellexec runasoriginaluser postinstall nowait skipifsilent; Description: "Start WIWBTOETSING?"
