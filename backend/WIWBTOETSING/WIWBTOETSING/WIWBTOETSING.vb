...
Module WIWBTOETSING
    ...
    Sub Main()
        ...
        Else
            ...
            ToetsData.STATS2024 = Setup.GeneralFunctions.GetBooleanFromString(My.Application.CommandLineArgs(2))
            ToetsData.HUIDIG = Setup.GeneralFunctions.GetBooleanFromString(My.Application.CommandLineArgs(3))
            ToetsData.ALL_2030 = Setup.GeneralFunctions.GetBooleanFromString(My.Application.CommandLineArgs(4))
            ToetsData.GL_2050 = Setup.GeneralFunctions.GetBooleanFromString(My.Application.CommandLineArgs(5))
            ToetsData.GH_2050 = Setup.GeneralFunctions.GetBooleanFromString(My.Application.CommandLineArgs(6))
            ToetsData.WL_2050 = Setup.GeneralFunctions.GetBooleanFromString(My.Application.CommandLineArgs(7))
            ToetsData.WH_2050 = Setup.GeneralFunctions.GetBooleanFromString(My.Application.CommandLineArgs(8))
            ToetsData.GL_2085 = Setup.GeneralFunctions.GetBooleanFromString(My.Application.CommandLineArgs(9))
            ToetsData.GH_2085 = Setup.GeneralFunctions.GetBooleanFromString(My.Application.CommandLineArgs(10))
            ToetsData.WL_2085 = Setup.GeneralFunctions.GetBooleanFromString(My.Application.CommandLineArgs(11))
            ToetsData.WH_2085 = Setup.GeneralFunctions.GetBooleanFromString(My.Application.CommandLineArgs(12))
            ToetsData.SessionID = My.Application.CommandLineArgs(13)
            ToetsData.OrderNum = My.Application.CommandLineArgs(14)
            ToetsData.Naam = Setup.GeneralFunctions.RemoveBoundingQuotes(My.Application.CommandLineArgs(15))
            ToetsData.MailAdres = Setup.GeneralFunctions.RemoveBoundingQuotes(My.Application.CommandLineArgs(16))
