<html>
  <head>
    <title>Process Referentie L</title>
  </head>
...
<?php 
    ...
    // **
    // ** 2012-04-10
    // ** ScriptProcessReferentie.php       v-67
	...
	$RemarkFromForm = $_POST['OpmerkingRegioL'];
...
//      Foldername is hard-coded :                                      // *
	...
	$FileHardCoded = "Regio_L_1906-2010.txt";                       // *
...
// This function dumps the Reference-array into the database :
	...
	$Key = assemble_keys($Keys,'data.regionlraw');
    ...
    // Access the table :
    	$sQuery = "SELECT * FROM data.regionlraw" ;
