<html>
  <head>
    <title>Process Stochasten </title>
  </head>
...
<?php 
    ...
    // **
    // ** 2012-04-10
    // ** ScriptProcessStochasten.php       v-67
...
<?php 
    ...
    $dbHandle=0;
    $sMasterUser = "postgres";
    $sMasterPassword = "W8Meester";
    $sHost = "localhost";
    $sPoort ="5432";
    $sDataBase = "dbregendata";
    $sTableName = "tborder";
