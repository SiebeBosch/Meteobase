<html>
  <head>
    <title>Process Uurgegevens </title>
  </head>
...
<?php 
    ...
    // **
    // ** This script imports the Hourly precipitation into the PostgreSQL-RDBMS
    ...
    // **
    // ** 2012-04-10
    // ** ScriptProcessUurgegevens.php      v-67
...
//      Foldername is hard-coded :                                      // *
	$FolderFromForm = "D:\METEOBASE\Dataload\Uur";                       // *
...
// *************************************************************************
	...
	echo "<b><u>Neerslag (Uurwaarden)</b></u>" . "<br>";
...
$pRecordCounter = $pRecordCounter + 1 ;
	...
	$Hour  = trim($items[2]) ;
	$Rain  = trim($items[3]) ;
	$Balance  = trim($items[4]) ;

	$NewRecord = Array($Station , $Date , $Hour, $Rain, $Balance );
...
//	$Keys[4] = "extra";
	...
	$Key = assemble_keys($Keys,'data.precipitation_hourly');
