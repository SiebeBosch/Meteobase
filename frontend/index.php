...
<head>
    ...
    <script src="https://code.jquery.com/jquery-1.11.0.js"
        integrity="sha256-zgND4db0iXaO7v4CLBIYHGoIIudWI5hRMQrPB20j0Qw=" crossorigin="anonymous"></script>
...
<script src="https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
    ...
    <script type="text/javascript"
        src="https://cdn.jsdelivr.net/npm/cookie-bar/cookiebar-latest.min.js?forceLang=nl&tracking=1&thirdparty=1&always=1&refreshPage=1&top=1&showNoConsent=1&hideDetailsBtn=1&showPolicyLink=1&privacyPage=https%3A%2F%2Fwww.meteobase.nl%2Fmeteobase%2Fdownloads%2Ffixed%2Fliteratuur%2F20230302_privacyverklaring_Meteobase.pdf">
    </script>

    <script type="text/javascript">
    function melding() {
        document.getElementById('dl').innerHTML =
            '<p>Uw bestelling wordt verwerkt. U ontvangt binnen een enkele uren een e-mail<br />met een downloadlink. U mag dit tabblad verlaten.</p>';
    ...
    function check() {
        ...
        if (wDag) {
            document.getElementById('waarde_dag').click();
        }
        if (wUur) {
            document.getElementById('waarde_uur').click();
        }
    }
...
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 map-container pull-right">
                            ...
                            <div class="row">
                                <div id="toetsingsdata-toggle">
                                    <input type="radio" name="toetsingsdata-select" checked
                                        id="toetsingsdata-year-select"> Hele jaar<br />
                                    <input type="radio" name="toetsingsdata-select" id="toetsingsdata-winter-select">
                                    Winterseizoen
                                </div>
                                ...
                                <div id="legend">
                                    ...
                                    <ul class="legend-items">
                                        <li class="legend-item">
                                            <div class="colour" style="background-color: rgb(50, 136, 189);"></div><span
                                                class="item">&lt; 5</span>
                                        </li>
                                        <li class="legend-item">
                                            <div class="colour" style="background-color: rgb(102, 194, 165);"></div>
                                            <span class="item">5-10</span>
                                        </li>
                                        <li class="legend-item">
                                            <div class="colour" style="background-color: rgb(171, 221, 164);"></div>
                                            <span class="item">10-30</span>
                                        </li>
                                        <li class="legend-item">
                                            <div class="colour" style="background-color: rgb(230, 245, 152);"></div>
                                            <span class="item">30-50</span>
                                        </li>
                                        <li class="legend-item">
                                            <div class="colour" style="background-color: rgb(255, 255, 191);"></div>
                                            <span class="item">50-70</span>
                                        </li>
                                        <li class="legend-item">
                                            <div class="colour" style="background-color: rgb(254, 224, 139);"></div>
                                            <span class="item">70-90</span>
                                        </li>
                                        <li class="legend-item">
                                            <div class="colour" style="background-color: rgb(253, 174, 97);"></div><span
                                                class="item">90-100</span>
                                        </li>
                                        <li class="legend-item">
                                            <div class="colour" style="background-color: rgb(244, 109, 67);"></div><span
                                                class="item">100-500</span>
                                        </li>
                                        <li class="legend-item">
                                            <div class="colour" style="background-color: rgb(213, 62, 79);"></div><span
                                                class="item">&gt; 500</span>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="g-recaptcha" data-sitekey="6LfK6mwiAAAAAD8zxTDZXfvsis9CoxgnoW5rSpdG"
                            data-size="invisible">
                        </div>
                        <?php } ?>
                                ...
                                <header class="head-container" data-stellar-background-ratio="0.5"
                                    ...
                                    <div class="top-bar col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <ul class="mobile-menu">
                                            ...
                                            <li><a href="?tb=rasterdata&dp=rasterdata&dp_sub=introductie">Downloaden</a>
                                            </li>
                                            <li><a
                                                    href="?tb=rasterview&dp=rasterview&dp_sub=introductie">Herhalingstijd</a>
                                            </li>
                                            ...
                                            <li><a href="#" class="modal-opener" data-toggle="modal"
                                    ...
                                    <div class="row">
                                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                            <ul class="nav navbar-nav">
                                                <li class="registration"><a class="modal-opener" href="#"
                                                        data-toggle="modal" data-target="#registerModal">Registreren</a>
                                                </li>
                                                <li><a href="?tb=basisgegevens&dp=basisgegevens">Basisgegevens</a></li>
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                                                        ...
                                                        aria-expanded="false">Rasterdata <span class="caret"></span></a>
                                                    <ul class="dropdown-menu">
                                                        <li><a
                                                                href="?tb=rasterdata&dp=rasterdata&dp_sub=introductie">Downloaden</a>
                                                        </li>
                                                        <li><a
                                                                href="?tb=rasterview&dp=rasterview&dp_sub=introductie">Herhalingstijd</a>
                                                        </li>
                                                        <li><a href="?tb=satdata&dp=satdata&dp_sub=introductie">SAT Data
                                                                2.0</a></li>
                                                        <!--<li><a href="?tb=rasterHarmonie&dp=rasterHarmonie&dp_sub=introductie">Hirlam/Harmonie</a></li>-->
                                                    </ul>
                                                </li>
                                                <li class="dropdown">
                                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                                                        ...
                                                        href="?tb=toetsingsdata&dp=toetsingsdata">Statistiek <span
                                                            class="caret"></span></a>
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a
                                                                href="?tb=toetsingsdata&dp=toetsingsdata">Toetsingsdata</a>
                                                        </li>
                                                        <li>
                                                            <a href="#" class="modal-opener" data-toggle="modal"
                                                        ...
                                                        <li>
                                                            <a href="#" class="modal-opener" data-toggle="modal"
                                                                data-target="#chartDialogOppervlaktereductie">Oppervlaktereductie</a>
                                                        </li>
                                                        <li>
                                                            <a href="?tb=stedelijk&dp=toetsingsdata">Neerslaggebeurtenissen
                                                                stedelijk</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                                                        role="button" aria-haspopup="true"
                                                        aria-expanded="false">Documentatie <span
                                                            class="caret"></span></a>
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a href="#" class="modal-opener" data-toggle="modal"
                                ...
                                <div class="partners content-row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-3 col-sm-12 col-xs-12 partner-logo">
                                            <a href="https://www.hetwaterschapshuis.nl" target="_blank"><img
                                                    src="images/hetwaterschaps.png" class="img-responsive"
                                                    alt="Het Waterschapshuis"></a>
                                        </div>
                                        <div class="col-md-3 col-sm-12 col-xs-12 partner-logo">
                                            <a href="https://www.stowa.nl" target="_blank"><img src="images/stowa.png"
                                                    class="img-responsive" alt="STOWA"></a>
                                        </div>
                                        <div class="col-md-3 col-sm-12 col-xs-12 partner-logo">
                                            <a href="https://www.hydroconsult.nl" target="_blank"><img
                                                    src="images/logo_hc.png" class="img-responsive"
                                                    alt="Hydroconsult.nl"></a>
                                        </div>
                                        <div class="col-md-3 col-sm-12 col-xs-12 partner-logo">
                                            <a href="https://www.hydrologic.com" target="_blank"><img
                                                    src="images/hydrologic.png" class="img-responsive"
                                                    alt="hydrologic"></a>
                                        </div>
                                        <div class="col-md-3 col-sm-12 col-xs-12 partner-logo">
                                            <a href="https://www.hkv.nl" target="_blank"><img src="images/logo_hkv.png"
                                                    class="img-responsive" alt="HKV"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" id="registerModalForm" action="<?php echo($_SERVER["PHP_SELF"]); ?>"
                        ...
                        <div class="form-group col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="userFullName" id="userFullName" class="form-control"
                                    value="<?php if (isset($_COOKIE['gebruiker'])) { echo $_COOKIE['gebruiker']['naam'];} else { echo '';} ?>"
                                    placeholder="Full Name" aria-describedby="name">
                            </div>
                        </div>
                        <div class="form-group col-md-12 col-md-12">
                            <label for="userCompany">Bedrijf</label>
                            <div class="input-group">
                                <span class="input-group-addon" id="company"><i
                                        class="glyphicon glyphicon-briefcase"></i></span>
                                <input type="text" id="userCompany" name="userCompany" class="form-control"
                                    value="<?php if (isset($_COOKIE['gebruiker'])) { echo $_COOKIE['gebruiker']['org'];} else { echo '';} ?>"
                                    placeholder="Company" aria-describedby="company">
                            </div>
                        </div>
                        <div class="form-group col-md-12 col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="userEmail" name="userEmail" class="form-control"
                                    placeholder="Email"
                                    value="<?php if (isset($_COOKIE['gebruiker'])) { echo $_COOKIE['gebruiker']['mail'];} else { echo '';} ?>"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button"
                        class="btn submit-btn btn-primary"><?php if (isset($_COOKIE['gebruiker'])) { echo 'Bijwerken';} else { echo 'Registreren';} ?></button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <form method="POST" id="feedbackModalForm" action="index.php?tb=feedback" class="register-modal">
                        <div class="form-group col-md-6 col-sm-12 col-xs-12">
                            ...
                            <input type="text" name="userFullNameFeedback" id="userFullNameFeedback"
                                class="form-control" placeholder="Name" aria-describedby="name">
                        </div>
                        <div class="form-group col-md-6 col-sm-12 col-xs-12">
                            <label for="userEmailFeedback">E-mail</label>
                            <input type="text" id="userEmailFeedback" name="userEmailFeedback" class="form-control"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <p>
                            Op de site van de overheidsinstantie <a
                                href="https://www.waarschuwingsdienst.nl/Risicos/Inbreuk+op+je+privacy/Cookies-+een+bedreiging+voor+uw+privacy.html"
                                target="_blank">Waarschuwingsdienst.nl</a>
                ...
                <div class="modal-body">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <p>
                            ...
                            Het bijbehorende rapport kunt u <a
                                href="https://www.meteobase.nl/meteobase/downloads/fixed/Rapport_Meteobase_definitief.pdf"
                ...
                <div class="modal-body">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <ul>
                            ...
                            <li>
                                Versteeg R., et al., 2012, <a href="https://www.meteobase.nl"
                            ...
                            <li>
                                Meteobase,
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/Handleiding_regenduurlijnen.pdf"
                                    target="_blank">
                            ...
                            <li>
                                Meteobase,
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/Handleiding_oppervlaktereductie.pdf"
                                    target="_blank">
                            ...
                            <li>
                                Meteobase,
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/Handleiding_SATDATA20.pdf"
                                    target="_blank">
                        ...
                        <ul>
                            <li>
                                Het Waterschapshuis,
                                <a href="https://portal.hydronet.com/data/files/Technische%20Instructies%20WIWB%20API.pdf"
                                    target="_blank">
                            ...
                            <li>
                                Hydrologic,
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/P951_FAQ_WIWB_Februari_2020.pdf"
                                    target="_blank">
                            ...
                            <li>
                                Hydrologic,
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/WIWB_aanmelden_WIWB_API.xlsx"
                                    target="_blank">
                            ...
                            <li>
                                Het Waterschapshuis,
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/P951_Voorbeeldverzoeken_WIWB_API.pdf"
                                    target="_blank">
                        ...
                        <ul>
                            <li>
                                HKV,
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/Toelichting_Meteobase_rasters_2018.pdf"
                                    target="_blank">
                                    “Toelichting Meteobase-rasters 2018”
                                </a>
                                , Memorandum HKV Lijn-in-water, 27 maart 2019;
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/statistieken_reanalysis_validatie_2018.pdf"
                                    target="_blank">
                                    “Bijlage: analyse neerslagrasters 2018”;
                                </a>
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/memo_verwachtingskwaliteit_2021.pdf"
                                    target="_blank">
                            ...
                            <li>
                                ...
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/Hurkmans2015_HKV_memo_Beschrijving_aanpassingen_neerslagrasters.pdf"
                                    target="_blank">
                            ...
                            <li>
                                Kallen, M.-J. (2013),
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/Kallen2012_constructie_neerslagrasters.pdf"
                                    target="_blank">
                        ...
                        <ul>
                            ...
                            <li>
                                De Bruin, H.A.R. (2014),
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/deBruin2014_Meteorologica_referentiegewasverdamping.pdf"
                                    target="_blank">
                            ...
                            <li>
                                De Bruin, H.A.R. (1987),
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/Hooghart1987_Evaporation_and_weather_proceedings_no39.pdf"
                                    target="_blank">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                , KNMI. <a
                                    href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/samenvatting_rapport_correctiemethoden.pdf"
                                    target="_blank">Samenvatting.</a>
                            </li>
                            <li>
                                ...
                                , Ingediend bij Geophysical Research Letters. <a
                                    href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/samenvatting_onderzoek_kwaliteitscontrole_neerslagmetingen_WIWB_Nederlands.pdf"
                                    target="_blank">Nederlandstalige samenvatting.</a>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/Beersma2018_STOWAneerslagstatistiek_korteduren.pdf"
                                    target="_blank">
                            ...
                            <li>
                                ...
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/Overeem2012_KNMIrapport_statistiek_extreme_gebiedsneerslag.pdf"
                                    target="_blank">
                            ...
                            <li>
                                Smits, I. et al., (2004),
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/Smits2004_STOWArapport_neerslagstatistiek.pdf"
                                    target="_blank">
                        ...
                        <ul>
                            <li>
                                Vandersat (2021),
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/Plausibiliteits_rapport_2021_Satdata_3_0.pdf"
                                    target="_blank">
                            ...
                            <li>
                                Vandersat (2020),
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/Oplevering_2020_Satdata_3_0_002.pdf"
                                    target="_blank">
                            ...
                            <li>
                                eLEAF. (2017),
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/20171101_Methodiek SAT-DATA_eLEAF_v4.pdf"
                                    target="_blank">
                            ...
                            <li>
                                eLEAF. (2017),
                                <a href="https://www.meteobase.nl/meteobase/downloads/fixed/literatuur/20171101_Plausibiliteit_SAT-DATA_eLEAF_v4.pdf"
                                    target="_blank">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <form method="POST" id="polygonCoordinates" action="" class="polygonCoordinates">
                            <div class="form-group col-md-6 col-sm-12 col-xs-12">
                                ...
                                <input type="text" name="zwx" id="zwx" class="form-control"
                                    value="<?php if ($_COOKIE['minX']) { echo $_COOKIE['minX'];} else { echo '';} ?>"
                                    aria-describedby="name">
                            </div>
                            <div class="form-group col-md-6 col-sm-12 col-xs-12">
                                <label for="zxy">ZW Y</label>
                                <input type="text" id="zwy" name="zwy" class="form-control"
                                    value="<?php if ($_COOKIE['minY']) { echo $_COOKIE['minY'];} else { echo '';} ?>"
                                    aria-describedby="email">
                            </div>
                            <div class="form-group col-md-6 col-sm-12 col-xs-12">
                                <label for="nox">NO X</label>
                                <input type="text" name="nox" id="nox" class="form-control"
                                    value="<?php if ($_COOKIE['maxX']) { echo $_COOKIE['maxX'];} else { echo '';} ?>"
                                    aria-describedby="name">
                            </div>
                            <div class="form-group col-md-6 col-sm-12 col-xs-12">
                                <label for="noy">NO Y</label>
                                <input type="text" id="noy" name="noy" class="form-control"
                                    value="<?php if ($_COOKIE['maxY']) { echo $_COOKIE['maxY'];} else { echo '';} ?>"
                                    aria-describedby="email">
                            </div>
                        </form>
                    </div>
    ...
    function drawChart(jsonData) {
        if (jsonData === "false") {
            document.getElementById(chartname).innerHTML =
                "De combinatie van klimaat, periode en scenario is niet beschikbaar in deze studie.";
        } else {
    ...
    function drawChart2(jsonData) {
        ...
        if (jsonData === "false") {
            document.getElementById(chartname2).innerHTML =
                "De combinatie van klimaat, periode en scenario is niet beschikbaar in deze studie.";
        } else {
            // Create our data table out of JSON data loaded from server.
            var data = new google.visualization.DataTable(jsonData);
    ...
    function checkIE() {
        ...
        if (browser != false) {
            console.log('alert!')
            alert('Deze applicatie werkt niet goed in uw browser: Internet Explorer ' + browser +
                '. U kunt deze app gebruiken in Microsoft Edge (standaard beschikbaar in Windows 10), Chrome of Firefox.'
            )
            document.getElementById("chartDocument").innerHTML =
                'Deze applicatie werkt niet goed in uw browser: Internet Explorer ' + browser +
                '. U kunt deze app gebruiken in Microsoft Edge (standaard beschikbaar in Windows 10), Chrome of Firefox.'
        };
    };
    </script>
    ...
    <div class="modal fade" id="chartDialogStochasten" tabindex="-1" role="dialog"
        aria-labelledby="chartDialogStochastenTitle">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        ...
                        <div class="col-sm-5 col-md-4 col-lg-3">
                            <form id="input_par_form">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select custom-select-sm form-control" id="climate"
                                        name="climate">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select custom-select-sm form-control" id="season"
                                        name="season">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="subcat custom-select custom-select-sm form-control" id="scenario"
                                        name="scenario">
                                        <optgroup data-rel="2024">
                                            <option value="-">-</option>
                                        </optgroup>
                                        <optgroup data-rel="2033">
                                ...
                                <div class="form-group" id="extra-data">
                                    ...
                                    <input type="number" class="form-control" step="1" min="1" max="1000" id="value"
                                        name="value">
                                </div>
                            ...
                            <div class="svgWarningWrapper" style="margin-top: 20px;display:none;">
                                <a href="#" class="modal-opener" data-toggle="modal"
                                    data-target="#chartDialogStochastenWarning">
    ...
    <div class="modal fade" id="chartDialogOppervlaktereductie" tabindex="-1" role="dialog"
        aria-labelledby="chartDialogAreaTitle">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        ...
                        <div class="col-sm-5 col-md-4 col-lg-3">
                            <form id="input_par_form2">
                                <div class="form-group" id="Oppervlak">
                                    ...
                                    <input type="number" class="form-control" step="0.1" min="6" max="965" id="area"
                                        name="area">
                                </div>
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-calculator"></i>
                        ...
                        <div class="col-sm-7 col-md-8 col-lg-9">
                            <div id="area_chartTab">
                                <div id="area_fragment-1">
                                    <div id="oppervlaktereductie"
                                        style="border: 1px solid #ccc; width: 100%; height: 100%; min-height: 400px;">
                                        selecteer input en druk op 'bereken'</div>
                                </div>
                            </div>
                            <div id="chartDownloadButtons" class="float-right" style="margin-top: 5px;">
    ...
    <!-- Chart warning Modal -->
    <div class="modal fade" id="chartDialogStochastenWarning" tabindex="-1" role="dialog"
        aria-labelledby="chartDialogStochastenWarningTitle">
        <div class="modal-dialog" role="document">
    ...
    $(function() {
        ...
        if ($('#rasterDataForm').length) {
            ...
            rasterData.split('&').forEach(function(
                keyValuePair) { // not necessarily the best way to parse cookies
        ...
        if ($('#basicInfoForm').length) {
            ...
            basicInfoData.split('&').forEach(function(
                keyValuePair) { // not necessarily the best way to parse cookies
                var cookieName = keyValuePair.replace(/=.*$/,
                    ""); // some decoding is probably necessary
                var cookieValue = keyValuePair.replace(/^[^=]*\=/,
        ...
        if ($('#rasterHarmonieForm').length) {
            ...
            rasterHarmonieData.split('&').forEach(function(
                keyValuePair) { // not necessarily the best way to parse cookies
                var cookieName = keyValuePair.replace(/=.*$/,
                    ""); // some decoding is probably necessary
                var cookieValue = keyValuePair.replace(/^[^=]*\=/,
        ...
        if ($('#rasterViewForm').length) {
            ...
            if (!_.isEmpty(rasterViewData)) {
                ...
                rasterViewData.split('&').forEach(function(
                    keyValuePair) { // not necessarily the best way to parse cookies
                    var cookieName = keyValuePair.replace(/=.*$/,
                        ""); // some decoding is probably necessary
                    var cookieValue = keyValuePair.replace(/^[^=]*\=/,
        ...
        if ($('#testingInfoForm').length) {
            ...
            testingInfoForm.split('&').forEach(function(
                keyValuePair) { // not necessarily the best way to parse cookies
                var cookieName = keyValuePair.replace(/=.*$/,
                    ""); // some decoding is probably necessary
                var cookieValue = keyValuePair.replace(/^[^=]*\=/,
        ...
        message = message +
            ' Zodra hij is afgehandeld, wordt hij klaargezet op de <a href="https://www.meteobase.nl/meteobase/downloads/">downloadpagina</a>. <br>';
