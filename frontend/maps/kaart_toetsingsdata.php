...
//		map: map,
//		icon: new google.maps.MarkerImage(locations[i][3], new google.maps.Size(30,30), new google.maps.Point(0,0), new google.maps.Point(15,15)),
//		title: locations[i][0],
//		zIndex: 1
//	}); 
...
//			if(colorImage == 'images/dot02.png'){
//				var tekstdel = 'ms['+locations[i][0]+']';
//				eraseCookie(tekstdel);
//				var selectedImage = new google.maps.MarkerImage('images/dot01.png', new google.maps.Size(30,30), new google.maps.Point(0,0), new google.maps.Point(15,15)); 
//				marker.setIcon(selectedImage);
//				marker.setZIndex(1);
//			}else{
//				var selectedImage = new google.maps.MarkerImage('images/dot02.png', new google.maps.Size(30,30), new google.maps.Point(0,0), new google.maps.Point(15,15)); 
//				marker.setIcon(selectedImage);
