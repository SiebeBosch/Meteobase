...
// CONFIGURABLE >>>>>>>>>>
	...
	ExportPrecipitation($dbHandle, $meteostations, $ValidatedDatum_van, $ValidatedDatum_tot, $area, $FileCsvNeerslag, $waarde, $NamesString, $StationsString, $sessionid, $NewOrder, $neerslag, $makkink, $naam, $mail);
