                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <label class="checkbox-label">
                                                <input type="checkbox" id="evapotranspiratie" name="evtact" value="evtact"> Actuele evapotranspiratie (SATDATA 3.0)
                                            </label>
                                            <label class="checkbox-label">
                                                <input type="checkbox" id="verdampingstekort" name="evtsho" value="evtsho"> Verdampingstekort (SATDATA 3.0)
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12 col-xs-12">
