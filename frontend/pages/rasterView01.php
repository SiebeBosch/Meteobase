        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="row">
                ...
                <div class="form-container">
                    <form method="POST" name="resterview" action="index.php?tb=rasterview&dp=rasterview" id="rasterViewForm" class="raster-view-form">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <label for="interval">Interval: <span id="interval">0 tot 1 dagen na gekozen datum (24 uur)</span></label>
                                <div class="row">
									<div class="col-md-12">
